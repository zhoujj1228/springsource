...
public class Flights implements java.io.Serializable {
    ...
    public void addFlight(
            final org.springframework.oxm.castor.Flight vFlight)
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        if (index < 0 || index >= this._flightList.size()) {
            throw new IndexOutOfBoundsException("getFlight: Index value '" + index + "' not in range [0.." + (this._flightList.size() - 1) + "]");
        }
     ...
     */
    public org.springframework.oxm.castor.Flight removeFlightAt(
            final int index) {
    ...
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this._flightList.size()) {
            throw new IndexOutOfBoundsException("setFlight: Index value '" + index + "' not in range [0.." + (this._flightList.size() - 1) + "]");
        }
     ...
     */
    public void setFlight(
            final org.springframework.oxm.castor.Flight[] vFlightArray) {
        //-- copy array
        _flightList.clear();
     ...
     */
    public static org.springframework.oxm.castor.Flights unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.springframework.oxm.castor.Flights) Unmarshaller.unmarshal(org.springframework.oxm.castor.Flights.class, reader);
    }
